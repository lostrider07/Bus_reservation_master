...
$patt5='/^[A-Za-z0-9]{3,10}$/';
$patt6='/^[A-Za-z0-9]{3,10}$/';
$patt7='/^[A-Za-z0-9]{4,10}$/';
$patt8='/^[A-Za-z0-90-9]{5,100}$/';
$patt9='/^[0-9]{10}$/';
...
die('Could not connect: ' . mysqli_error($conn));
	...
	$sql = "insert into vellore2 values('$name','$gen','$dob','$prg','$nation','$nlg','$blg','$eid','$padd','$pn');";
